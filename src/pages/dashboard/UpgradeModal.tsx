    ...
    <div className="modal-overlay" onClick={()=>setShowUpgradeModal(false)}>
      <div className="modal" onClick={e=>e.stopPropagation()} style={{maxWidth:920,width:'96%',textAlign:'left',maxHeight:'90vh',overflowY:'auto'}}>
        ...
        {upgradeTab==='metered' ? (<>
          ...
          <div style={{marginTop:16,padding:'14px 16px',borderRadius:12,background:'#f8fafc',border:'1px solid #e2e8f0',fontSize:12,color:'#64748b',lineHeight:1.7}}>포함 통화는 매월 초기화됩니다. 미응답과 통화시간에 따른 실제 차감은 서버의 일반전화 과금 규칙을 따르며, 충전 크레딧은 결제일로부터 1년 후 소멸합니다.</div>
        </>) : upgradeTab==='flat' ? (<>
