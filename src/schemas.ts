...
export const SubscribeRegisterResponseSchema = loose({
  ...
  storeId: z.string(),
  channelKey: z.string(),
  billingKeyMethod: z.enum(['CARD', 'TRANSFER', 'EASY_PAY']),
  issueName: z.string(),
  customerId: z.string(),
  amount: z.number(),
});
...
export const OpsMetricsSchema = loose({
  ...
  incidents: loose({
    missingScheduledToday: z.number(),
...
export const CallEngineProviderSchema = loose({
  ...
  runtime: loose({
    ...
    engineConnected: z.boolean().nullable().optional(),
    freeSwitchConnected: z.boolean().nullable().optional(),
    engineImage: z.string().nullable().optional(),
    engineImageDigest: z.string().nullable().optional(),
    freeSwitchImage: z.string().nullable().optional(),
    freeSwitchImageDigest: z.string().nullable().optional(),
    modAudioStreamHash: z.string().nullable().optional(),
    restartedAt: z.string().nullable().optional(),
    audioPlaybackSuccessRate: z.number().nullable().optional(),
    silentCallCount24h: z.number().nullable().optional(),
    lastHealthyCallAt: z.string().nullable().optional(),
    imageApproved: z.boolean().nullable().optional(),
